...
AddEventHandler("vRP:playerSpawn", function(user_id, source, first_spawn)
  ...
  if first_spawn then -- first spawn
    ...
    -- notify last login
    TriggerClientEvent("pNotify:SendNotification",player,{text = "<b style='color:orange'>Bem vindo. Pressione K para acessar o menu do jogador.</b>", type = "warning", timeout = math.random(1000, 10000),layout = "centerLeft"})
